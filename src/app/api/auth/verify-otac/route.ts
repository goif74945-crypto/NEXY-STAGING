...
const REQUEST_ID = 'auth_verify_otac_post';
...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    const payload = OtacVerifyInputSchema.parse(rawBody);
    const result = verifyDeterministicOtac(payload);
